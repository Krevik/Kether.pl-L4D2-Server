...
public void OnPluginStart()
{
	...
	g_hCvarMuteTime = CreateConVar(			"sm_votemute_mutetime",				"3600",		"How long player will be muted (in sec.)", CVAR_FLAGS );
	g_hCvarGagTime = CreateConVar(			"sm_votemute_gagtime",				"3600",		"How long player will be gagged (in sec.)", CVAR_FLAGS );
	...
	g_hCvarVetoFlag = CreateConVar(			"sm_votemute_vetoflag",				"d",		"Admin flag required to veto/votepass the vote", CVAR_FLAGS );
	...
	//g_hCvarInstaMute = CreateConVar(		"sm_votemute_instant_mute",			"1",		"Use instant mute when somebody joined with microphone on (1 - Yes / 0 - No)", CVAR_FLAGS );
	//g_hCvarInstaMuteWait = CreateConVar(	"sm_votemute_instant_mute_wait",	"5",		"Grace time in seconds waiting for player to switch off the microphone after he is joined", CVAR_FLAGS );
	
	AutoExecConfig(true,				"sm_votemute");
	
	RegConsoleCmd("sm_votemute", 	Command_Votemute, 	"Show menu to select player to vote for mute/unmute");
	RegConsoleCmd("sm_vm", 			Command_Votemute,	"Show menu to select player to vote for mute/unmute");
	RegConsoleCmd("sm_votegag", 	Command_Votegag,	"Show menu to select player to vote for gag/ungag");
	RegConsoleCmd("sm_vg", 			Command_Votegag,	"Show menu to select player to vote for gag/ungag");
