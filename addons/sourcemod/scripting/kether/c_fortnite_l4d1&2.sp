...
public void OnPluginStart() {
    ...
    RegAdminCmd("sm_emotes", Command_Menu, ADMFLAG_GENERIC, "[SM] Usage: sm_setemotes <#userid|name> [Emote ID]", "");
    RegAdminCmd("sm_emote", Command_Menu, ADMFLAG_GENERIC, "[SM] Usage: sm_setemotes <#userid|name> [Emote ID]", "");
    RegAdminCmd("sm_dances", Command_Menu, ADMFLAG_GENERIC, "[SM] Usage: sm_setemotes <#userid|name> [Emote ID]", "");
    RegAdminCmd("sm_dance", Command_Menu, ADMFLAG_GENERIC, "[SM] Usage: sm_setemotes <#userid|name> [Emote ID]", "");
	...
	RegConsoleCmd("sm_stopemote", Cmd_StopEmote, "Stop Emote");
...
public Action Cmd_StopEmote(int client, int args)
{
	StopEmote(client);
    return Plugin_Handled;
}
