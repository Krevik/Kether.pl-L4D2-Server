...
public OnPluginStart()
{
	...
	cvar_AnnounceRankChange = CreateConVar("l4d_stats_announcerank", "0", "Chat announcment for rank change", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvar_AnnouncePlayerJoined = CreateConVar("l4d_stats_announceplayerjoined", "0", "Chat announcment for player joined.", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	cvar_AnnounceMode = CreateConVar("l4d_stats_announcemode", "0", "Chat announcment mode. 0 = Off, 1 = Player Only, 2 = Player Only w/ Public Headshots, 3 = All Public", FCVAR_PLUGIN, true, 0.0, true, 3.0);
	...
	cvar_SilenceChat = CreateConVar("l4d_stats_silencechat", "1", "Silence chat triggers. 0 = Show chat triggers, 1 = Silence chat triggers", FCVAR_PLUGIN, true, 0.0, true, 1.0);
	...
	//cvar_MaxPoints = CreateConVar("l4d_stats_maxpoints", "99999", "Maximum number of points that can be earned in a single map. Normal = x1, Adv = x2, Expert = x3", FCVAR_PLUGIN, true, 500.0);
