...
new Handle: g_hForwardWitch100 = INVALID_HANDLE;
...
public OnPluginStart()
{
	...
	g_hForwardWitch100 = CreateGlobalForward("OnWitch100BySurvivor", ET_Ignore, Param_Cell, Param_Cell );
}
...
PrintWitchDamage()
{
	...
	for (new k; k <= survivor_index; k++)
	{
		...
		if(percent_damage == 100){
			Call_StartForward(g_hForwardWitch100);
			Call_Finish();
		}
	}
}
