...
public void OnPluginStart()
{
    ...
    g_hCvar_Duration           = CreateConVar("l4d_spot_marker_duration", "4.0", "Duration (seconds) of the spot marker.", CVAR_FLAGS, true, 0.0);
    g_hCvar_Cooldown           = CreateConVar("l4d_spot_marker_cooldown", "15.0", "Cooldown (seconds) to use the spot marker.", CVAR_FLAGS, true, 0.0);
    g_hCvar_SkillReadySound    = CreateConVar("l4d_spot_marker_skill_ready_sound", "", "Skill ready sound.\nEmpty = OFF.", CVAR_FLAGS);
    ...
    g_hCvar_FieldAlpha         = CreateConVar("l4d_spot_marker_field_alpha", "100", "Beacon field alpha transparency.\n0 = Invisible, 255 = Fully Visible.", CVAR_FLAGS, true, 0.0, true, 255.0);
    ...
    g_hCvar_SpriteAlpha        = CreateConVar("l4d_spot_marker_sprite_alpha", "155", "Sprite alpha transparency.\nNote: Some models don't allow to change the alpha.\n0 = Invisible, 255 = Fully Visible", CVAR_FLAGS, true, 0.0, true, 255.0);
    ...
    g_hCvar_Intro              = CreateConVar("l4d_spot_marker_intro", "0", "Show intro message in chat this many seconds after a client joins.\n0 = OFF.", CVAR_FLAGS, true, 0.0);
    g_hCvar_IntroMsg           = CreateConVar("l4d_spot_marker_intro_msg", "0", "Display type for the \"Intro\" message.\n0 = OFF, 1 = CHAT, 2 = HINT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", displays the message in CHAT and as a HINT.", CVAR_FLAGS, true, 0.0, true, 3.0);
    g_hCvar_SkillReadyMsg      = CreateConVar("l4d_spot_marker_skill_ready_msg", "0", "Display type for the \"Skill Ready\" message.\n0 = OFF, 1 = CHAT, 2 = HINT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", displays the message in CHAT and as a HINT.", CVAR_FLAGS, true, 0.0, true, 3.0);
    g_hCvar_SpotMarkedMsg      = CreateConVar("l4d_spot_marker_spot_marked_msg", "2", "Display type for the \"Spot Marked\" message.\n0 = OFF, 1 = CHAT, 2 = HINT.\nAdd numbers greater than 0 for multiple options.\nExample: \"3\", displays the message in CHAT and as a HINT.", CVAR_FLAGS, true, 0.0, true, 3.0);
    ...
    // Admin Commands
	RegConsoleCmd("sm_spotmarker", CmdSpotMarker, "Create a spot marker on self crosshair (no args) or specified targets crosshair. Example: self -> sm_spotmarker / target -> sm_spotmarker @bots");
