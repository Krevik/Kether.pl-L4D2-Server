...
public void OnPluginStart()
{
    ...
    g_hCvar_PumpShotgun       = CreateConVar("l4d2_wskin_pump_shotgun", "0", "Weapon skin option for Pump Shotgun.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_ShotgunChrome     = CreateConVar("l4d2_wskin_shotgun_chrome", "0", "Weapon skin option for Chrome Shotgun.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_AutoShotgun       = CreateConVar("l4d2_wskin_auto_shotgun", "0", "Weapon skin option for Auto Shotgun.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SMGUzi            = CreateConVar("l4d2_wskin_smg_uzi", "0", "Weapon skin option for SMG Uzi.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SMGSilenced       = CreateConVar("l4d2_wskin_smg_silenced", "0", "Weapon skin option for Silenced SMG.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleM16          = CreateConVar("l4d2_wskin_rifle_m16", "0", "Weapon skin option for M16 Rifle.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleAK47         = CreateConVar("l4d2_wskin_rifle_ak47", "0", "Weapon skin option for AK47 Rifle.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_HuntingRifle      = CreateConVar("l4d2_wskin_hunting_rifle", "0", "Weapon skin option for Hunting Rifle.\n0 = OFF, 1 = ON.", CVAR_FLAGS, true, 0.0, true, 1.0);
