...
{	
	CheckDependencyVersions(/*throw*/false);
	/*
	*/
}
...
PrepareAllSDKCalls()
{
	...
	{
		ThrowError("Could not load gamedata/left4dhooks.l4d2.txt");
	}
...
DisplayScrambleVote()
{
	FakeClientCommandAll("sm_unready");
	FakeClientCommandAll("sm_hide");
	CreateTimer(5, ProcessVoting);
}

public Action ProcessVoting(Handle timer)
{
...
CheckDependencyVersions(bool:throwError=false)
{
	#if !SCORE_DEBUG
